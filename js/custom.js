...
$(function() {
  ...
  // KBW-Countdown Start
  // --------------------------------------------- //
  $('#countdown').countdown({until: $.countdown.UTCDate(+10, 2023, 5, 18), format: 'D'});
  $('#countdown-large').countdown({until: $.countdown.UTCDate(+10, 2023, 5, 18), format: 'DHMS'});
  // --------------------------------------------- //
  // KBW-Countdown End
  // --------------------------------------------- //
  ...
  if(bgndKenburns.length){
    bgndKenburns.vegas({
      ...
      slides: [
        { src: "img/backgrounds/1000x1200-bg-media-1.jpg" },
        { src: "img/backgrounds/1000x1200-bg-media-2.jpg" },
        { src: "img/backgrounds/1000x1200-bg-media-3.jpg" }
      ],
